...
public class BaseConversion
{
     ...
     * run 方法，用于实现进制转换
     */
//    public static String run(String get)
//    {
//        int index1 = 3;
//        int index2 = 3;
//        while (true)
...
//            index1 = Integer.parseInt(option);
//                System.out.println("请输入转化的第二个类型：\n" +
//                        "1.二进制\n" +
//                        "2.八进制\n" +
//                        "3.十进制\n" +
//                        "4.十六进制");
//            index2 = Integer.parseInt(get.split(" ")[1]);
//            printType(index1, index2);
//            }
...
//     */
    ...
    {
        String temp = "";
        String number = get.split(" ")[0];//number to chg
        int oldType = Integer.parseInt(get.split(" ")[1]);
        int newType = Integer.parseInt(get.split(" ")[2]);
        switch (oldType)
        {
            case 2:
    ...
    public static void main(String[] args) {
        System.out.println(run("1111 2 10"));
    }
}
